    ...
    public partial class frmClientes : Form
    {
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                respuesta = NPersona.Insertar("Cliente", txtNombre.Text, cmbTipos.Text, txtDocumento.Text, txtDireccion.Text, txtTelefono.Text, txtEmail.Text);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                respuesta = NPersona.Actualizar(getUserID(nombreAnterior), "Cliente", nombreAnterior, txtNombre.Text, cmbTipos.Text, txtDocumento.Text, txtDireccion.Text, txtTelefono.Text, txtEmail.Text);
                if (respuesta == "OK")
                {
