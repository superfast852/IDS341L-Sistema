...
namespace Sistema.Presentacion
{
    public partial class FrmVista_ProveedorIngreso : Form
    {
        ...
        {
            // HERE IS WHERE THE NAME AND ID ARE BEING SET OHMYGOOODODDDD
            // IT ESTABLISHES A LINK THROUGH THAT STATIC CLASS YOU DONT NEED ALL THE PERSONA AND INGRESO FLUFF
